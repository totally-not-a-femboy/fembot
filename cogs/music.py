#Exctracted from https://github.com/Daishiky/music-discord/blob/main/cogs/music.py
import asyncio
import functools
import itertools
import math
...
class Music(commands.GroupCog):
    ...
    @commands.hybrid_command(help="Make me join in a VC", aliases = ["join"], invoke_without_subcommand=True)
    ...
    @commands.hybrid_command(help="Summon me in a VC", aliases = ["summon"])
    ...
    @commands.hybrid_command(help="Make me leave a VC", aliases = ["leave"])
...
# Search whatever u want on youtube!
    @commands.hybrid_command(name="volume",help="Set the player volume", aliases = ["vol"])
    ...
    @commands.hybrid_command(name="now", help="See the actual song in playing", aliases=['current', 'playing'])
    async def _now(self, ctx: commands.Context):

        await ctx.send(embed=ctx.voice_state.current.create_embed())

    @commands.hybrid_command(name='pause', help='Pause the actual player')
    ...
    @commands.hybrid_command(name='resume', help="Resume the paused player")
    ...
    @commands.hybrid_command(name="stop", help="Stop the current song")
    ...
    @commands.hybrid_command(name='queue', help="See the song queue")
    ...
    @commands.hybrid_command(name='play', help="Play a song in a VC")
