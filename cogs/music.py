    ...
    async def connect_(self, ctx, channel: discord.VoiceChannel=None):
        ...
        if not channel:
            try:
                ...
                raise InvalidVoiceChannel('No hay canal para unirse. Especifique un canal válido o únase a uno.')
        ...
        if vc:
            ...
            try:
                ...
                raise VoiceConnectionError(f'Moving to channel: {channel.mention} timed out.')
        else:
            try:
                await channel.connect()
            except asyncio.TimeoutError:
                raise VoiceConnectionError(f'Connecting to channel: {channel.mention} timed out.')
